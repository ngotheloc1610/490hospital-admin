...
export const API_SEARCH_DOCTOR = "/admin/searchPractitionerRole";
export const API_ALL_GET_STAFF = "/admin/staffs";
export const API_SEARCH_STAFF = "/admin/searchPractitionerRole";
...
export const SCHEDULE_UPDATE = "/schedule/update-Schedule/"
...
export const API_INBOX_ROOM_ADD_PRACTITIONER = "/inbox-room/add-practitioner"
export const API_INBOX_ROOM_NOT_ROOM = "/inbox-room/practitioners-not-in-room"
export const API_INBOX_ROOM_SEARCH = "/inbox-room/searchPatientsFromInboxRoom"

export const API_INBOX_MESSAGE = "/inbox-message/"
export const API_INBOX_MESSAGE_SEND = "/inbox-message/message"
export const API_INBOX_MESSAGE_FILE = "/inbox-message/message-with-file"

export const API_DEVICE_TOKEN = "/device/token"
export const API_DEVICE_REMOVE = "/device/remove"
export const API_DEVICE_CREATE = "/device"
...
export const API_DASHBOARD_ALL_PATIENT_GENDER = "/dashboard/returning-gender-per-day"
...
export const API_ALERT_UPDATE = "/alert/updateAlertSetting/"
export const API_ALERT_DELETE = "/alert/deleteAlertSetting/"
