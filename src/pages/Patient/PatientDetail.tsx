...
const PatientDetail = () => {
    ...
    return (
        <section className="patient-detail container">
            <div>
                <h3 className="fw-bold pb-3 mb-3 text-uppercase border-bottom">{patient?.nameFirstRep?.text}</h3>
                <table className="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{patient?.telecom?.find((i: any) => i?.system === "email")?.value}</td>
                        </tr>
            ...
            <div className="mt-5">
                <h3 className="fw-bold text-uppercase border-top pt-3 ">Diagnostic Report</h3>
